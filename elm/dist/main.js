...
{
	if (region.P.D === region.T.D)
	{
		return 'on line ' + region.P.D;
	}
	return 'on lines ' + region.P.D + ' through ' + region.T.D;
}
...
var $author$project$Main$init = function () {
	var defaultDay = A2(
		...
		0,
		$elm$core$List$head(
			$elm$core$List$reverse($author$project$Model$allPuzzles)));
	return A3(
...
var $author$project$Day01$readInput = function (s) {
	return A2(
		$elm$core$List$map,
		A2(
...
var $author$project$Day01$runSolution = F2(
	function (dropN, input) {
		var readings = $author$project$Day01$readInput(input);
...
var $author$project$Day02$Down = function (a) {
	return {$: 1, a: a};
};
var $author$project$Day02$Forward = function (a) {
	return {$: 0, a: a};
};
var $author$project$Day02$Up = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Day02$maybeToList = function (m) {
	if (!m.$) {
		var x = m.a;
		return _List_fromArray(
			[x]);
...
var $author$project$Day02$readInstructions = function () {
	var readInstruction = function (s) {
		...
		if ((_v0.b && _v0.b.b) && (!_v0.b.b.b)) {
			...
			switch (i) {
				case 'forward':
					return $elm$core$Maybe$Just(
						$author$project$Day02$Forward(value));
				case 'down':
					return $elm$core$Maybe$Just(
						$author$project$Day02$Down(value));
				default:
					return $elm$core$Maybe$Just(
						$author$project$Day02$Up(value));
			}
		} else {
			return $elm$core$Maybe$Nothing;
		}
	...
	return A2(
		...
		A2(
			$elm$core$Basics$composeR,
			$elm$core$List$map(readInstruction),
			$elm$core$List$concatMap($author$project$Day02$maybeToList)));
}();
var $author$project$Day02$AimPos = F2(
	function (aim, pos) {
		return {x: aim, E: pos};
	});
var $author$project$Day02$Position = F2(
	function (hor, depth) {
		return {l: depth, t: hor};
	});
var $author$project$Day02$zeroPosition = A2($author$project$Day02$Position, 0, 0);
var $author$project$Day02$zeroAimPos = A2($author$project$Day02$AimPos, 0, $author$project$Day02$zeroPosition);
var $author$project$Day02$solve = function (s) {
	var updatePosition = F2(
		function (instr, pos) {
			switch (instr.$) {
				case 0:
					var f = instr.a;
			...
			switch (instr.$) {
				...
				default:
					...
					var newPos = _Utils_update(
						oldPos,
						{l: oldPos.l + (f * aimPos.x), t: oldPos.t + f});
					return _Utils_update(
						aimPos,
						{E: newPos});
			}
		});
	var instructions = $author$project$Day02$readInstructions(s);
	var part1 = function () {
		var finalPos = A3($elm$core$List$foldl, updatePosition, $author$project$Day02$zeroPosition, instructions);
		return finalPos.t * finalPos.l;
	}();
	var part2 = function () {
		var finalPos = A3($elm$core$List$foldl, updateAimPos, $author$project$Day02$zeroAimPos, instructions);
		return finalPos.E.t * finalPos.E.l;
	}();
	return A2(
		$author$project$Model$PuzzleResult,
		$elm$core$Maybe$Just(
			$elm$core$String$fromInt(part1)),
		$elm$core$Maybe$Just(
		...
		switch (msg.$) {
			...
			default:
				return _Utils_update(
					model,
					{
						N: $author$project$Main$runPuzzle(model)
					});
		}
	});
...
var $author$project$Main$dayButton = F2(
	function (model, puzzle) {
		var buttonClass = _Utils_eq(puzzle, model.J) ? 'button-primary' : '';
		return _List_fromArray(
			[
				A2(
...
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{az: $author$project$Main$init, aJ: $author$project$Main$update, aK: $author$project$Main$view});
